            ...
            <div>
                <div class="card">              
                    <div class="card-header">
                        <img className="round-img" src ={this.props.user.user[0].Profile_pic} alt="Avatar" />
                        <div>Metallica</div>
                    ...
                    <div className = "cmnts">
                        <img className="round-img-cmnts"src={this.props.user.user[0].Profile_pic} alt=""/><textarea className = "comments" name="comments" placeholder="Write a comment..." rows="1" cols="50" onChange = {e => this.change(e)}/><button className="btn btn-primary btn-xs _btnsize" onClick = {e => this.commentPost(this.props.post.postId)}>Post</button>
                    </div>
                </div>
                <br /> 
            </div>
...
export default connect(mapStateToProps, { delPost })(NewsFeed);